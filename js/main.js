(async () => {
    ...
    //マップ設定   
    $.getJSON("https://raw.githubusercontent.com/rikunn/Kyoshin-Monitor-EX-/main/EEWJapanMap(Correct).geojson", function (data1) {
        L.geoJSON(data1,
            {
                style: PolygonStyle,
    ...
    $.getJSON("https://raw.githubusercontent.com/rikunn/Kyoshin-Monitor-EX-/main/EEwWorldMap(EX).geojson", function (data2) {
        L.geoJSON(data2,
            {
                style: PolygonStyle,
                onEachFeature: function onEachFeature(
